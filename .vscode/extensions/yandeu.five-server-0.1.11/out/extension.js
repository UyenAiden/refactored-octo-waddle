...
function activate(context) {
    ...
    const startServer = (uri) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (workspace) {
            ...
            if (workspace && typeof root !== "undefined" && (uri === null || uri === void 0 ? void 0 : uri.fsPath)) {
                let file = uri.fsPath
                ...
                if (debug)
                    pty.write("Open:", file);
                yield fiveServer.start(Object.assign(Object.assign({}, config), { injectBody: shouldInjectBody(), open: file, root,
                    workspace, _cli: true }));
            }
            else {
                if (debug)
                    pty.write("Open:", "");
                yield fiveServer.start(Object.assign(Object.assign({}, config), { injectBody: shouldInjectBody(), root,
                    workspace, _cli: true }));
            }
        }
        else if (!workspace) {
